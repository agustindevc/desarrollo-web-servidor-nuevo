...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($tmp_fecha_lanzamiento == '') {
            $err_fecha_lanzamiento = "La fecha de lanzamiento es obligotira";
        } else {
    ...
    <div class="container">
        ...
        <form class="col-4" action="" method="post">
            ...
            <div class="mb=3">
                <label for="form-label">Fecha de lanzamiento</label>
                <input class="form-cntrol" type="date" name="fecha_lanzamiento">
